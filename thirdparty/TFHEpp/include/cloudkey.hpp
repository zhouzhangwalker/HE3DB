...
struct EvalKey {
    ...
    template <class Archive>
    void serialize_params(Archive &archive)
    {
        archive(params);
    }

    template <class Archive>
    void serialize_bklvl01(Archive &archive)
    {
        archive(params, bklvl01);
    }

    template <class Archive>
    void serialize_bklvl02(Archive &archive)
    {
        archive(params, bklvl02);
    }

    template <class Archive>
    void serialize_bkfftlvl01(Archive &archive)
    {
        archive(params, bkfftlvl01);
    }

    template <class Archive>
    void serialize_bkfftlvl02(Archive &archive)
    {
        archive(params, bkfftlvl02);
    }

    template <class Archive>
    void serialize_bknttlvl01(Archive &archive)
    {
        archive(params, bknttlvl01);
    }

    template <class Archive>
    void serialize_bknttlvl02(Archive &archive)
    {
        archive(params, bknttlvl02);
    }

    template <class Archive>
    void serialize_iksklvl10(Archive &archive)
    {
        archive(params, iksklvl10);
    }

    template <class Archive>
    void serialize_iksklvl11(Archive &archive)
    {
        archive(params, iksklvl11);
    }

    template <class Archive>
    void serialize_iksklvl20(Archive &archive)
    {
        archive(params, iksklvl20);
    }

    template <class Archive>
    void serialize_iksklvl21(Archive &archive)
    {
        archive(params, iksklvl21);
    }

    template <class Archive>
    void serialize_iksklvl22(Archive &archive)
    {
        archive(params, iksklvl22);
    }

    template <class Archive>
    void serialize_privksklvl11(Archive &archive)
    {
        archive(params, privksklvl11);
    }

    template <class Archive>
    void serialize_privksklvl21(Archive &archive)
    {
        archive(params, privksklvl21);
    }

    template <class Archive>
    void serialize_privksklvl22(Archive &archive)
    {
        archive(params, privksklvl22);
    }
